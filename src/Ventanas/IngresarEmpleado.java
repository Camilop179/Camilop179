...
public class IngresarEmpleado extends javax.swing.JDialog {
       ...
       public void agregar(){
        ...
        if (!((jTextFieldCedula.getText()+jTextFieldCelular.getText()+jTextFieldNombre.getText()).equals(""))) {
            try {
                ...
                PreparedStatement pre = cn.prepareStatement("INSERT INTO empleados (id,cedula,nombre,Telefono,Correo) values(?,?,?,?,?)");
                pre.setInt(1, 0);
                pre.setString(2,jTextFieldCedula.getText());
                pre.setString(3, jTextFieldNombre.getText());
                pre.setString(4, jTextFieldCelular.getText().trim());
                pre.setString(5, jTextFieldCorrep.getText().trim());
    ...
    private void initComponents() {
        ...
        jTextFieldCorrep = new javax.swing.JTextField();
        ...
        jTextFieldCorrep.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextFieldCorrepKeyPressed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGap(9, 9, 9)
                                .addComponent(jLabelGuardar, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabelSalir, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(35, 35, 35))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(7, 7, 7)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextFieldCorrep, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 35, Short.MAX_VALUE)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabelSalir, javax.swing.GroupLayout.DEFAULT_SIZE, 39, Short.MAX_VALUE)
    ...
    private void jTextFieldCelularKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCelularKeyPressed
        if(!Validaciones.validarEnter(evt)){
            jTextFieldCorrep.requestFocus();
        }
    }//GEN-LAST:event_jTextFieldCelularKeyPressed

    private void jTextFieldCorrepKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCorrepKeyPressed
        if(!Validaciones.validarEnter(evt)){
            agregar();
            if(m){
                Ventas.llenarEmpleado();
            }
        }
    }//GEN-LAST:event_jTextFieldCorrepKeyPressed
    ...
    private javax.swing.JTextField jTextFieldCorrep;
