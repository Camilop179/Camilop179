 ...
 * @author harol
 */
public class SubInventario extends javax.swing.JFrame {
    ...
    public static void marca() {
        ...
        try {
            ...
            PreparedStatement pre = cnn.prepareStatement("select * from subinventario");
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        if (!jTextFieldMarca.getText().equals("")) {
            String nombre = jTextFieldMarca.getText();
            try {

                Connection cn = Conexion.Conexion();
                PreparedStatement pre = cn.prepareStatement("INSERT INTO subinventario (id,nombre) value(?,?)");
                pre.setInt(1, 0);
